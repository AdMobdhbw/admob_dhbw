...
class URLItems {
    ...
    var cloudFunctionsURL = [
        ...
        "https://firebase.google.com/docs/functions/case-studies"
    ]
    ...
    var realtimeDatabaseURL = [
        ...
        "https://firebase.google.com/docs/database/ios/backups",
        "https://firebase.google.com/docs/database/ios/profile"
    ]
    ...
    var storageURL = [
        ...
        "https://firebase.google.com/docs/storage/ios/file-metadata",
        "https://firebase.google.com/docs/storage/ios/delete-files",
        "https://firebase.google.com/docs/storage/ios/handle-errors"
    ]
    ...
    var appIndexingURL = [
        ...
        "https://firebase.google.com/docs/app-indexing/ios/app",
        "https://firebase.google.com/docs/app-indexing/ios/test",
        "https://firebase.google.com/docs/app-indexing/ios/measure"
    ]
    ...
    var invitesURL = [
        ...
        "https://firebase.google.com/docs/invites/ios"
    ]
    ...
    var adMobURL = [
        ...
        "https://firebase.google.com/docs/admob/admob-firebase",
